...
type LoginRequest struct {
	...
	Email     string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Password  string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`
	ServiceId string `protobuf:"bytes,3,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"` // ID сервиса, в котором пользователь авторизуется
}
...
var file_sso_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x49, 0x64, 0x22, 0x32, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73,
	...
	0x17, 0x5a, 0x15, 0x67, 0x72, 0x70, 0x63, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x73, 0x73, 0x6f, 0x2e,
